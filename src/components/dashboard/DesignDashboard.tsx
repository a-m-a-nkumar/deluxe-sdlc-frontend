            ...
            <div key={s.n} className="flex items-center gap-1 flex-1">
              <div className="flex items-center gap-2 flex-shrink-0">
                <div
                  ...
                  style={{
                    backgroundColor: s.done ? "#16a34a" : i === arr.findIndex(x => !x.done) ? "#1B3C71" : "#e5e7eb",
                ...
                <span
                  ...
                  style={{ color: s.done ? "#16a34a" : i === arr.findIndex(x => !x.done) ? "#1B3C71" : "#9ca3af" }}
                >
                  {s.label}
                </span>
              </div>
          ...
          <div className="xl:col-span-2 border-r border-gray-200 bg-white flex flex-col p-5 h-full overflow-hidden">
            <div className="flex items-center justify-between mb-4 flex-shrink-0">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#1B3C71" }}>
                ...
                {isLoadingEditXML ? (
                  ...
                  <>
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-2" style={{ backgroundColor: "rgba(27,60,113,0.06)" }}>
                      <Pencil className="w-7 h-7" style={{ color: "#1B3C71" }} />
                    </div>
              ...
              <div className="flex flex-col h-full p-5 gap-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#1B3C71" }}>
              ...
              <div className="flex flex-col h-full p-5 gap-4">
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-3 space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button className="flex-1 text-white" onClick={handlePushToConfluence} disabled={isPushingToConfluence || !confluenceSpaceKey} style={{ backgroundColor: "#1B3C71" }}>
            ...
            return (
              <div className="flex flex-col h-full p-5 gap-3">
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0" style={{ backgroundColor: "#1B3C71" }}>2</div>
                  <div className="flex-1 min-w-0">

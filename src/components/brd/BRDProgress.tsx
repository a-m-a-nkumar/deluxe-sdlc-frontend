import { CheckCircle, Circle, Users, Target, List, Database, Shield, FileText, Settings, FileStack, Loader2 } from "lucide-react";
...
export const BRDProgress = ({ selectedSection, onSectionChange, completedSections, hasProjectAndTemplate = false, disabled = false, onSectionClick, showDocumentOverview = false, dynamicSections, onViewEntireBRD, isFetchingSection = false, isLoadingSections = false }: BRDProgressProps) => {
      ...
      <CardContent className="flex-1 overflow-y-auto pr-3">
        {isLoadingSections ? (
          <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
            ...
            <p className="text-sm">Loading BRD sections...</p>
          </div>
        ) : disabled ? (
          ...
          <div className="space-y-2">
            ...
            {dynamicSections.map((section) => {
              ...
              const isDisabled = isFetchingSection;
              return (
                <button
                  key={section.title}
                  disabled={isDisabled}
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {isActive && isFetchingSection ? "Loading..." : section.description}
                      </p>
                    </div>
                    {isBRDApproved && (
